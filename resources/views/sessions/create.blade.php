...
<div class="max-w-7xl mx-auto space-y-8">
    <div>
        <nav class="flex mb-2 text-sm text-gray-500">
            ...
            <span class="mx-2">/</span>
            <span class="text-gray-700">إضافة</span>
        </nav>
        <h1 class="text-3xl font-bold text-gray-900 tracking-tight">إضافة جلسة جديدة</h1>
        <p class="text-sm text-gray-500 mt-1">أدخل تفاصيل الجلسة وربطها بالقضية المناسبة</p>
    </div>
                ...
                <div class="bg-white rounded-2xl shadow-md border border-gray-100 overflow-hidden">
                    ...
                    <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div class="md:col-span-2">
                            ...
                            <select name="case_id" class="w-full px-3 py-3 rounded-2xl border border-gray-200 bg-gray-50 focus:bg-white focus:border-[#1c5bb8] focus:ring-2 focus:ring-[#1c5bb8]/20 @error('case_id') border-red-500 @enderror">
                                ...
                                @foreach($cases as $case)
                                    <option value="{{ $case->id }}" {{ (string) old('case_id', $selectedCaseId) === (string) $case->id ? 'selected' : '' }}>
                        ...
                        <div>
                            ...
                            <input type="date" name="session_date" value="{{ old('session_date') }}" class="w-full px-3 py-3 rounded-2xl border border-gray-200 bg-gray-50 focus:bg-white focus:border-[#1c5bb8] focus:ring-2 focus:ring-[#1c5bb8]/20 @error('session_date') border-red-500 @enderror">
                            @error('session_date')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="time" name="session_time" value="{{ old('session_time') }}" class="w-full px-3 py-3 rounded-2xl border border-gray-200 bg-gray-50 focus:bg-white focus:border-[#1c5bb8] focus:ring-2 focus:ring-[#1c5bb8]/20 @error('session_time') border-red-500 @enderror">
                            @error('session_time')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="court" value="{{ old('court') }}" class="w-full px-3 py-3 rounded-2xl border border-gray-200 bg-gray-50 focus:bg-white focus:border-[#1c5bb8] focus:ring-2 focus:ring-[#1c5bb8]/20 @error('court') border-red-500 @enderror">
                            @error('court')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="room" value="{{ old('room') }}" class="w-full px-3 py-3 rounded-2xl border border-gray-200 bg-gray-50 focus:bg-white focus:border-[#1c5bb8] focus:ring-2 focus:ring-[#1c5bb8]/20 @error('room') border-red-500 @enderror">
                            @error('room')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <select name="status" class="w-full px-3 py-3 rounded-2xl border border-gray-200 bg-gray-50 focus:bg-white focus:border-[#1c5bb8] focus:ring-2 focus:ring-[#1c5bb8]/20 @error('status') border-red-500 @enderror">
                                ...
                                <option value="done" {{ old('status') === 'done' ? 'selected' : '' }}>منعقدت</option>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="notes" rows="4" class="w-full px-3 py-3 rounded-2xl border border-gray-200 bg-gray-50 focus:bg-white focus:border-[#1c5bb8] focus:ring-2 focus:ring-[#1c5bb8]/20 @error('notes') border-red-500 @enderror" placeholder="أضف أي ملاحظات تخص الجلسة...">{{ old('notes') }}</textarea>
                            @error('notes')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
